...
with open(f"./results/test/{trainer}/{algorithm_name}_{metric}_{steps}.csv", 'r') as file:
    for line in file:
...
# Median line
plt.plot(epochs, medians, label="VIT - Median", color="red", linewidth=2)
...
plt.fill_between(epochs, (medians - std), (medians + std), color="orange", alpha=0.4, label="VIT - Std Dev")
